---
description: "多语言字符串集成助手。查询、集成、替换多语言字符串。"
argument-hint: <要集成的中文字符串>
allowed-tools: mcp__language__search-string, mcp__language__export-string, mcp__language__write-locales, mcp__language__get-version-list, Read, Write, Edit, Glob, Grep, Agent, TodoWrite, AskUserQuestion
---
